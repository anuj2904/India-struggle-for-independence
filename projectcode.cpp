...
void fire(float x, float y)
{
    ...
    draw_circle(x, y, 1.2);
    draw_circle(x  , y+1,.8 );
    draw_circle(x , y+2, 0.5);
     
}
void sleepinglittleboys(float x, float y)
{
    ...
    glVertex2f(x + 2, y + 4.5);
    glVertex2f(x + 5, y + 4.5);
    ...
    glVertex2f(x + 5, y - 0.5);
    glVertex2f(x + 5, y + 4.5);
    glVertex2f(x + 9, y + 4.5);
    glVertex2f(x + 9, y - 0.5);
    glEnd();
    //neck
    glBegin(GL_POLYGON);
    glColor3f(1, 1, 0);
    glVertex2f(x + 9, y + 1);
    glVertex2f(x + 9, y + 3);
    glVertex2f(x + 10.5, y + 3);
    glVertex2f(x + 10.5, y + 1);
    glEnd();
    //hair
    glColor3f(0, 0, 0);
    draw_circle(x + 12.5, y + 2, 2);
    //face
    glColor3f(1, 1, 0);
    draw_circle(x + 12, y + 2, 2);
    //hands
    glBegin(GL_POLYGON);
    glColor3f(1, 1, 0);
    glVertex2f(x + 4, y + 4.5);
    glVertex2f(x + 4, y + 5.5);
    glVertex2f(x + 9, y + 5.5);
    glVertex2f(x + 9, y + 4.5);
    glEnd();
    glBegin(GL_POLYGON);
    glColor3f(1, 1, 0);
    glVertex2f(x + 4, y - 1.5);
    glVertex2f(x + 4, y - 0.5);
    glVertex2f(x + 9, y - 0.5);
...
void screen2()
{
    ...
    glColor3f(1,0,0);
    fire(97,31);
    draw_circle(105,70,2);
    draw_circle(105,69,2);
    draw_circle(105,68,1.5);
    glColor3f(0,0,0);   
    glBegin(GL_LINES);
    glVertex2i(75,21);
    glVertex2i(75,30);
    ...
    draw_circle(75,70,2);
    draw_circle(75,69,2);
    draw_circle(75,68,1.5);   
    sleepinglittleboys(75,60);
    glColor3f(1,0,0);
    draw_circle(75,65,2);
    draw_circle(80,60,2);
    draw_circle(73,58,1.5);   
    glutSwapBuffers();
